...
interface OrderAckPDFDocumentProps {
  info: Order;
...
const DiagonalLine = ({ language }: { language: string }) =>
  language === "ENG" ? (
    <Svg width={100} height={8}>
      <Path d="M4 0 L100 0 L100 8 L0 8 Z" fill="#142952" />
    </Svg>
  ) : (
  ...
  <>
    <View style={styles.header}>
      <View style={styles.titleContainer}>
        <Text style={styles.logoTitle}>
          {language === "KOR" ? "주문확인서" : "ORDER ACKNOWLEDGEMENT"}
        </Text>
    ...
    <View style={styles.inquiryInfoWrap}>
      <View style={styles.inquiryInfoColumn}>
        ...
        <View style={styles.inquiryInfoBox}>
          <View style={styles.inquiryInfoText}>
            <Text style={styles.inquiryInfoTitle}>ORDER ACKNOWLEDGEMENT</Text>
          </View>
          <View style={styles.inquiryInfoText}>
